          ...
          <div className="grid grid-cols-1 gap-5">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
              <div className="space-y-2">
                ...
                <BasicDropdown
                  label={t("form.registrationPolicy")}
                  items={[
                    { id: "open", label: t("policyOptions.open") },
                    { id: "approval", label: t("policyOptions.approval") },
                    { id: "inviteOnly", label: t("policyOptions.inviteOnly") },
                  ]}
                  selectedId={registrationPolicy}
                  onChange={(item) =>
                    setRegistrationPolicy(item.id as RegistrationPolicy)
                  }
                  className="mt-1 w-full"
                />
              </div>
              <div className="space-y-2">
                ...
                <BasicDropdown
                  label={t("form.isRegistrationRequired")}
                  items={[
                    { id: "no", label: t("booleanOptions.no") },
                    { id: "yes", label: t("booleanOptions.yes") },
                  ]}
                  selectedId={isRegistrationRequired ? "yes" : "no"}
                  onChange={(item) =>
                    setIsRegistrationRequired(item.id === "yes")
                  }
                  className="mt-1 w-full"
                />
              </div>
              <div className="space-y-2">
                ...
                <BasicDropdown
                  label={t("form.allowWaitlist")}
                  items={[
                    { id: "no", label: t("booleanOptions.no") },
                    { id: "yes", label: t("booleanOptions.yes") },
                  ]}
                  selectedId={allowWaitlist ? "yes" : "no"}
                  onChange={(item) => setAllowWaitlist(item.id === "yes")}
                  className="mt-1 w-full"
                />
              </div>
            </div>
