...
import { Save, X, Bell, Globe2, User2 } from "lucide-react";
...
export default function AdminSettingsPage(): ReactElement {
  ...
  const [employeeId, setEmployeeId] = useState<string>("MCSY-2025-0142");

  // Security (not used in Admin Settings page in this minimal version)
  ...
  function handleSave(e: FormEvent<HTMLFormElement>): void {
    e.preventDefault();
    // Dummy: do nothing; could show a toast in future
  }
